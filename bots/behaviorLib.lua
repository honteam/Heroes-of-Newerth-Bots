...
DontBreakChannel -	99	if channeling
PreGame -			97	if GetMatchTime() <= 0
Shop -				30,98	30 if there is something to buy, 98 if GetMatchTime() <= 0
...
--
--	Utility: 99 if you are channeling, 0 otherwise
--	Execute: Do nothing
----------------------------------

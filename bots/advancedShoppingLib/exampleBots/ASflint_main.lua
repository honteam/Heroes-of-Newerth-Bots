--FlintBot v1.0
--[[
advShopping implementations:
-default usage (lines 46-47)
-itemHandler (Shroud) (line 419)
-custom options: no item reservations and no purchase of consumables (65-83)
findItems is not needed (373-403)
